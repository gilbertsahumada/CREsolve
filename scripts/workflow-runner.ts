/**
 * Self-contained local workflow runner used by demo scripts.
 * Calls agents via HTTP and submits resolution directly on-chain with ethers.js.
 * The production CRE workflow lives under cre-workflow/cresolver-resolution/.
 */
